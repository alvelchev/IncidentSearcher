...
import com.ds.facade.CategoryFacade;
...
public class CategoryController implements Serializable {
    ...
    @EJB
    private com.ds.facade.CategoryFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/msgs_en").getString("CategoryCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/msgs_en").getString("CategoryUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/msgs_en").getString("CategoryDeleted"));
        if (!JsfUtil.isValidationFailed()) {
